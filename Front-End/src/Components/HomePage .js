...
const HomePage = () => {
    ...
    //   Delivery Partner Register *****************************************************************
      const handleRegister =async (e) => {
        ...
        try{
            const response=await axios.post("https://delivery-orders-management-backend.onrender.com/delivery_partner_register",formData)
    ...
    //   Delivery Partner Login *****************************************************************
      const handleSubmit= async(e)=> {
        e.preventDefault();
        try{
            const response=await axios.post("https://delivery-orders-management-backend.onrender.com/delivery_partner_login",formData);
      ...
      const handleSellerRegister =async (e) => {
        ...
        try{
            const response=await axios.post("https://delivery-orders-management-backend.onrender.com/seller_partner_register",formData)
            // alert(response.data.message)
            if(response.data.message==="User registered successfully"){
              toast.success("✅ User registered successfully", {
                position: "top-center",
    ...
    //   Seller Partner Login *****************************************************************
      const handleSellerSubmit= async(e)=> {
        e.preventDefault();
        try{
            const response=await axios.post("https://delivery-orders-management-backend.onrender.com/seller_partner_login",formData);
            // alert(response.data.message);
            if(response.data.message==="Login successfully"){
              toast.success("✅ Login successfully", {
                position: "top-center",
